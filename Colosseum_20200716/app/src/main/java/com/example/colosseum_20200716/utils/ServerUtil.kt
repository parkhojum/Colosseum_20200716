...
fun postRequesNotificationChek(context: Context,sideId: Int , handler: JsonResponseHandler?) {
    ...
    client.newCall(request).enqueue(object : Callback {
        ...
        //        의견 좋아요 / 싫어요
        fun postRequesReplyLikeOrDislike(context: Context,replyId: Int, isLike:Boolean, handler: JsonResponseHandler?) {
...
//        의견 달기
        fun postRequesReReply(context: Context,parentReplyId:Int  ,content:String ,handler: JsonResponseHandler?) {
